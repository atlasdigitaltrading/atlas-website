...
const products = [
  {
    ...
    color: "#3b82f6",
    tagline:
      "The institutional order and execution management system for hedge funds, asset managers, and proprietary trading firms.",
    features: [
      "Smart order routing across 16+ CEX and DEX venues, with execution-quality and security screening built in",
      ...
      "Broker- and venue-neutral, with optional self-custody and full auditability",
    ],
